...
private:
    ...
    {
        std::u16string utf16FileName = const_cast<std::u16string>(exp.getSystemId());
        std::u16string utf16Message = const_cast<std::u16string>(exp.getMessage());
...
public:
    ...
    {
        std::u16string utf16string = const_cast<std::u16string>(resourceIdentifier->getNameSpace());
...
public:
    ...
    std::string GetAttributeValue(const std::string& attributeName) override
    {
        ...
        auto utf16string = const_cast<std::u16string>(m_element->getAttribute(nameAttr.Get()));
