...
namespace MsixTest { namespace Pack {
    ...
    namespace TestConstants {
        ...
        constexpr wchar_t* ContentType = L"dummy/appx.test+txt";
        ...
        const std::array<std::pair<std::string, std::wstring>, 18> GoodFileNames =
        { {
        ...
        const std::array<std::wstring, 35> BadFileNames = {
            L"",
            L"/",
            L"\\abc",
            L"[CONTent_typeS].xMl",
