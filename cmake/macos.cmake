...
if (CMAKE_OSX_ARCHITECTURES MATCHES "arm64")
    ...
    if (XCODE_VERSION LESS 12.0)
        ...
        message(FATAL_ERROR "arm64 is only supported on Xcode 12. Found version ${XCODE_VERSION}. To enable arm64 builds please download Xcode 12 and run `sudo xcode-select -switch /Applications/Xcode-beta.app/Contents/Developer`")
    endif()
endif()
