...
# RunTest 0x8bad0041 .\..\appx\BlockMap\Invalid_Bad_Block.appx "-ss"            ### WIN8-era package
# RunTest 0x00000000 .\..\appx\BlockMap\Size_wrong_uncompressed.appx "-ss"      ### WIN8-era package
